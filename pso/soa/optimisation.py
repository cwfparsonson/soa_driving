...
class PSO:
    ...
    def __runPsoAlgorithm(self):
        ...
        while curr_rep <= self.rep_max:
            ...
            cpso = chaos_optimization.chaos(self.n, self.m, self.q, self.sim_model, self.t2, self.X0, self.cost_f, self.st_importance_factor, self.SP, map_type = 'tent', change_range = True)
