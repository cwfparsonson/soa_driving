...
class PSO:
    ...
    def __init__(self, 
                 ...
                 awg=None, 
                 osc=None, 
                 awg_res,         #how many voltage values it can take - verticle sampling
                 min_val=-1.0, 
                 max_val=1.0, 
    ...
    if sim == True:
        ...
        while(x<=10):
            ...
            for num_points in num_points_list:   
                counter = 0
                directory = ('/home/uceelkh/Desktop/SOA_Complexity/PSO_Data/Fall/New_23_04/n={}'.format(n) + '/points={}'.format(num_points) +'/Run={}'.format(x))
