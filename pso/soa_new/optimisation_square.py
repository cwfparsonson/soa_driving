...
class PSO:
    ...
    def __getPsoPerformance(self, 
        ...
        st_index = int(ft_rt_st_os_analysis[len(ft_rt_st_os_analysis)-1, 4])        #fall time added
    ...
    if sim == True:
        ...
        while(x<=2):
            ...
            for num_points in num_points_list:   
                counter = 0
                directory = ('/Users/hadi/Desktop/SOA_Complexity/PSO_Data/Fall/n={}'.format(n) + '/points={}'.format(num_points) +'/Run={}'.format(x))
                            # set dir to save data  
                            # /Users/hadi/Desktop/SOA_Complexity/PSO_Data/points={} - local directory
                            # /home/uceelkh/Desktop/SOA_Complexity/PSO_Data/points={} - mammoth directory  
                            # /home/uceelkh/Desktop/SOA_Complexity/PSO_Data/new_upsampled/points={} - mammoth directory 2  
