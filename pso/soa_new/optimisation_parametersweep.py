...
class PSO:
    ...
    def __evaluateParticlePositions(self, particles, curr_iter=None, plot=False):
        ...
        if plot == True:
            ...
            index_Ten = analyse.ResponseMeasurements(best_PV, self.t2).idxTen
            index_Ninety = analyse.ResponseMeasurements(best_PV, self.t2).idxNinety
            Inflection = analyse.ResponseMeasurements(best_PV, self.t2).inflectionTimeIndex
...
if __name__ == '__main__':
    ...
    #driving_signals_list = [30]   #number of input driving signals 
    #n = 3
    iter_max = 150
    rep_max = 1  
    max_v_f = 0.05
        ...
        while(x<=11):
            for n in driving_signals_list:
                for num_points in num_points_list:   
                    counter = 0
                    directory = ('/Users/hadi/Desktop/SOA_Complexity/PSO_Data//ParameterSweep_2/n={}'.format(n) + '/points={}'.format(num_points) +'/Run={}'.format(x))
