import sys, os
main_directory = r"C:\Users\onglab\Desktop\SOA_project\Chris\soa_optimisation" # set where python modules are stored
sys.path.append(main_directory) # add module location to python path
